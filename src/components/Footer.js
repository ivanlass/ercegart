...
function Footer() {
    ...
    <div className="footer" >
        <h2 className="footer-label">Contact us</h2>
    ...
    0038766325145
        ...
        <br/>
        <p className="footer-item"><span className="footer-placeholder"><svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.5" y="0.5" width="15" height="9" rx="1.5" stroke="#484848"/>
            <path d="M1 1L6.5 4.14286L8 5L9.5 4.14286L15 1" stroke="#484848"/>
        </svg>
    </span> asd@gmail.com</p>
</div>
);
}
